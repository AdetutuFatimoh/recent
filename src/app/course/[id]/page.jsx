...
export default function page({params}) {
  ...
  return (
    <article className="text-left">
        <h1 className="text-center border-b-8 border-sky-7-- py-4 uppercase">{list.name}</h1>
        <Image src={list.image} alt={list.name} width= {300} height={300}/>
        <h2 className="py-2 texl-2xl"><span className="font-bold">keywords: </span>{list.keywords.join(',')}</h2>
